...
unlocked to sign the IXCoin-Qt.app bundle.
...
allowing somebody to distribute a IXCoin-Qt.app or ixcoin-qt-setup.exe with a valid
...
that the ixcoin-qt.exe file inside the installer had not been tampered with.
