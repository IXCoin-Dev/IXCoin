...
WORKINGDIR="/tmp/ixcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/ixcoin/IXCoin/ixcoin-0.9.0rc1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/ixcoin/IXCoin/"
VERSIONPREFIX="ixcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'ixcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[ixcoin-]<version>-[rc[0-9]] (example: ixcoin-0.7.1-rc1)"
   echo "wget output:"
