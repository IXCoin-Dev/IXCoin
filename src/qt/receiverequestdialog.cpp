...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatIXCoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + IXCoinUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatIXCoinURI(info));
}
