...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/ixcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("IXCoin"),
     ...
     * override -datadir in the ixcoin.conf file in the default data directory
     * (to be consistent with ixcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
