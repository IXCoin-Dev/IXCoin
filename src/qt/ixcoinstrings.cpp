...
QT_TRANSLATE_NOOP("ixcoin-core", "Listen for connections on <port> (default: 8333 or testnet: 18333)"),
...
QT_TRANSLATE_NOOP("ixcoin-core", "RPC SSL options: (see the IXCoin Wiki for SSL setup instructions)"),
...
QT_TRANSLATE_NOOP("ixcoin-core", "SSL options: (see the IXCoin Wiki for SSL setup instructions)"),
