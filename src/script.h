...
#ifndef H_IXCOIN_SCRIPT
#define H_IXCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CIXCoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, IXCoin always counted CHECKMULTISIGs
