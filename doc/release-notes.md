IXCoin Core version 0.9.2 is now available from:
...
installer (on Windows) or just copy over /Applications/IXCoin-Qt (on Mac) or
ixcoind/ixcoin-qt (on Linux).
...
- Fix "Start ixcoin on system login"
