IXCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/ixcoin/files/IXCoin/ixcoin-0.5.4/
...
http://gitorious.org/ixcoin/ixcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix IXCoin-Qt notifications under Growl 1.3.
Increase required age of IXCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxIXCoin properly when installing IXCoin-Qt over it. (Windows)
