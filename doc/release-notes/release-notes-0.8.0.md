IXCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/ixcoin/files/IXCoin/ixcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the IXCoin
...
New/changed settings (command-line or ixcoin.conf file)
--------------------------------------------------------
