The following is a list of assets used in the ixcoin source and their proper attribution.
...
* License: MIT
* Site: [https://ixcointalk.org/index.php?topic=15276.0](https://ixcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original ixcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/ixcoin.icns, src/qt/res/src/ixcoin.svg,
	src/qt/res/src/ixcoin.ico, src/qt/res/src/ixcoin.png,
	src/qt/res/src/ixcoin_testnet.png, docs/ixcoin_logo_doxygen.png,
